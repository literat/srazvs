   ...
   <div id='headerCanvas'>
    <div id="headerContent">
	 <div id="headerProfileLogout">
      ...
      <a href="<?php echo HTTP_DIR."remote/logout.php?_return=admin/&_security_token=".$_SESSION[SESSION_PREFIX.'security_token'][0]; ?>" title="odhlásit se"><span>Odhlásit se</span></a>
