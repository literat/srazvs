		...
		JS_BRAMUS.jsProgressBar.prototype = {
			 ...
			 */				
				...
				initVisuals		: function () {
					...
					$(this.el).update(
						'<img id="' + this.id + '_percentImage" src="../../../../srazvs/inc/mpdf/progress/' + this.options.boxImage + '" alt="0%" style="width: ' + this.options.width + 'px; height: ' + this.options.height + 'px; background-position: ' + this.initialPos + 'px 50%; background-image: url('../../../../srazvs/inc/mpdf/progress/ + this.options.barImage[this.backIndex] + '); padding: 0; margin: 0;" class="percentImage" />' + 
