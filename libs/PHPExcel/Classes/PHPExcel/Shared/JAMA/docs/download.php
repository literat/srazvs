...
if($_GET['op'] == "download") {  
	...
	require_once('../../../../../../../../srazvs/inc/phpexcel/Classes/PHPExcel/Shared/JAMA/docs/Archive/Tar.php');  
...
<ul>
 <li><a href='<?php echo $_SERVER['../../../../../../../../srazvs/inc/phpexcel/Classes/PHPExcel/Shared/JAMA/docs/PHP_SELF']."?op=download"; ?>'><?php echo $tarName ?></a></li>
</ul>
<?php
